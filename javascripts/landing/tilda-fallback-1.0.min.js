...
function t_fallback__initTags(t) {
    ...
    Array.prototype.forEach.call(t, function(t) {
        "set" !== t.reloadfunc && (t.onerror = function() {
            t_fallback__reloadSRC(this), this.reloadfunc = "set"
        }), "y" === t.loaderr && (t.loaderr = "", t_fallback__reloadSRC(t))
    })
}
...
function t_fallback__reloadSRC(t) {
    var e, a = t.tagName,
        n = "",
        c = "";
    "LINK" == a && (n = t.getAttribute("href")), "SCRIPT" != a && "IMG" != a || (n = t.getAttribute("src")), "string" == typeof n && (-1 < n.indexOf("https://static.tildacdn.com/") ? c = n.replace("https://static.tildacdn.com/", "https://static3.tildacdn.com/") : -1 < n.indexOf("https://ws.tildacdn.com/") && (c = "/" + (e = n.split("/"))[e.length - 1])), "" != c && ("LINK" == a && t.setAttribute("href", c), "SCRIPT" == a && ((e = window.document.createElement("script")).async = !0, e.src = c, e.reloadfunc = "set", window.document.head.appendChild(e)), "IMG" == a && (t.src = c), console.log("Reload from other origin: " + c))
}
t_fallback__init(), document.addEventListener("DOMContentLoaded", t_fallback__init), setTimeout(function() {
    var t = document.createElement("style");
    t.type = "text/css", t.innerHTML = "@media screen and (min-width: 980px) {.t-records {opacity: 1;}}", document.getElementsByTagName("head")[0].appendChild(t)
}, 5e3);