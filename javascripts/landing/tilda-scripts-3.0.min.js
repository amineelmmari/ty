...
window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang, $(document).ready((function() {
    ...
    function(t) {
        t(document).ready((function() {
            ...
            if (-1 !== e.indexOf("Android") && (n || i || o || a || r)) {
                ...
                d.style.lineHeight = "100px", d.style.padding = "0", d.style.margin = "0", d.style.height = "auto", d.style.position = "absolute", d.style.opacity = "0.001", d.innerText = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", document.body.appendChild(d);
                var l = 100 / d.getBoundingClientRect().height;
                d.parentNode.removeChild(d), l < .98 && t("body").append('<style>.t396 [data-elem-type="text"] .tn-atom {zoom: ' + 100 * l + "%;}</style>")
            }
        }))
    }(jQuery),
    function(t) {
    ...
    function(t) {
        t(document).ready((function() {
            if (!window.isMobile && "yes" !== t("#allrecords").attr("data-blocks-animationoff") && !1 === window.isSearchBot) {
                ...
                function n() {
                    if (e.length)
                        for (var n = e.length - 1, o, a, r; n >= 0; n--)(a = (o = t(e[n])).offset().top) < (r = o.outerHeight() <= 100 ? i.scrollTop() + i.height() : i.scrollTop() + i.height() - 100) && (o.removeClass("r_hidden"), o.addClass("r_showed"), e.splice(n, 1))
                }
                e.each((function() {
    ...
    function(t) {
        ...
        function i() {
            ...
            t("div.r[data-screen-max], div.r[data-screen-min]").each((function() {
                "yes" !== t(this).attr("data-connect-with-tab") && (a = t(this).css("display"), void 0 === (n = t(this).attr("data-screen-max")) && (n = 1e4), n = parseInt(n), void 0 === (o = t(this).attr("data-screen-min")) && (o = 0), (o = parseInt(o)) <= n && (e <= n && e > o ? "block" != a && t(this).css("display", "block") : "none" != a && t(this).css("display", "none")))
            }))
        }
        t(document).ready((function() {
    ...
    function(t) {
        if (window.isMobile) {
            var e = function() {
                for (var e = document.body.querySelectorAll(".t-cover__carrier"), i = 0, n = 0, o = e.length, a, r, s, d, l, c; n < o; n++)
                    if ((r = (a = e[n]).style).height.indexOf("vh") > -1) {
                        i = parseInt(r.height, 10) / 100;
                        var h = document.createElement("div");
                        h.id = "tempDiv", h.style.cssText = "position:absolute;top:0;left:0;width:100%;height:100vh;visibility:hidden;", document.body.appendChild(h);
                        var p = t("#tempDiv").height();
                        t("#tempDiv").remove(), s = Math.round(p * i) + "px", (d = t(a).parent(".t-cover")) && (d = d[0]) && (l = d.querySelector(".t-cover__filter"), c = d.querySelector(".t-cover__wrapper"), l && (l.style.height = s), c && (c.style.height = s), r.height = d.style.height = s)
                    }
                var f = document.body.querySelectorAll("[data-height-correct-vh]"),
                    w = t(window).height();
                i = 0;
                for (var n = 0, o = f.length, a, r, s, d, l, c; n < o; n++)(r = (a = f[n]).style).height.indexOf("vh") > -1 && (i = parseInt(r.height) / 100, s = w + "px", d = t(a).parent(".t-cover"), r.height = s)
            };
            t(document).ready((function() {
                setTimeout((function() {
                    e()
                ...
                t("div[data-customstyle=yes]").each((function() {
                    ...
                    if (void 0 !== (e = t(this).attr("style")) && "" != e && e.indexOf("font-size") > -1 && t(this).css("font-size").replace("px", "") > 26)
                        if ("rem" === t(this).attr("data-auto-correct-font-size")) {
                            ...
                            var i = e.replace("font-size", "fontsize").replace("line-height", "lineheight");
                            t(this).attr("style", i)
                        }
                }))
            })), t(window).on("load", (function() {
